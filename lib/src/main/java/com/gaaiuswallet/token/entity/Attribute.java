...
import com.gaaiuswallet.token.util.DateTime;
import com.gaaiuswallet.token.util.DateTimeFactory;
        ...
        switch (getAs())
        {
            ...
            case Mapping:
                ...
                else
                {
                    ...
                    //refer to 'GAAIUSWallet meetup indices' where 'Match' mapping is null but for FIFA is not.
