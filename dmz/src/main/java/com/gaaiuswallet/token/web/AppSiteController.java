package com.gaaiuswallet.token.web;

import static com.gaaiuswallet.token.tools.Convert.getEthString;
import static com.gaaiuswallet.token.tools.ParseMagicLink.normal;
import static com.gaaiuswallet.token.web.Ethereum.TokenscriptFunction.ZERO_ADDRESS;
...
import com.gaaiuswallet.token.entity.NonFungibleToken;
...
import com.gaaiuswallet.token.web.Ethereum.TokenscriptFunction;
import com.gaaiuswallet.token.web.Ethereum.TransactionHandler;
import com.gaaiuswallet.token.web.Service.CryptoFunctions;
...
public class AppSiteController implements AttributeInterface
{
    ...
    private static final String appleAssociationConfig = "{\n" +
            ...
            "    \"details\": [\n" +
            "      {\n" +
            "        \"appID\": \"LRAW5PL536.com.stormbird.gaaiuswallet\",\n" +
            "        \"paths\": [ \"*\" ]\n" +
            "      }\n" +
            "    ]\n" +
            "  }\n" +
    ...
    public RedirectView home(RedirectAttributes attributes){
        return new RedirectView("http://gaaiuswallet.com");
    }
            ...
            throws IOException, SAXException, NoHandlerFoundException
    {
        ...
        {
            return "If you are using GAAIUSWallet with WalletConnect and facing issues please take the following steps:<br/><br/>\nTry using WalletConnect V2 (or latest version)<br/>\nTry launching the application from within GAAIUSWallet app's Browser tab.<br/>";
        }
