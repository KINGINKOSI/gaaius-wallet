...
import static com.gaaiuswallet.app.C.ALPHAWALLET_WEB;
import static com.gaaiuswallet.app.C.ETHER_DECIMALS;
import static com.gaaiuswallet.app.C.RESET_TOOLBAR;
import static com.gaaiuswallet.app.entity.tokens.Token.TOKEN_BALANCE_PRECISION;
import static com.gaaiuswallet.app.ui.HomeActivity.RESET_TOKEN_SERVICE;
import static com.gaaiuswallet.app.ui.MyAddressActivity.KEY_ADDRESS;
...
import static com.gaaiuswallet.token.entity.MagicLinkInfo.mainnetMagicLinkDomain;
...
import com.gaaiuswallet.app.entity.URLLoadInterface;
...
import com.gaaiuswallet.app.entity.analytics.QrScanResultType;
...
import com.gaaiuswallet.app.ui.widget.OnDappHomeNavClickListener;
import com.gaaiuswallet.app.ui.widget.entity.ActionSheetCallback;
import com.gaaiuswallet.app.ui.widget.entity.DappBrowserSwipeInterface;
import com.gaaiuswallet.app.ui.widget.entity.DappBrowserSwipeLayout;
import com.gaaiuswallet.app.ui.widget.entity.ItemClickListener;
...
import com.gaaiuswallet.app.viewmodel.DappBrowserViewModel;
import com.gaaiuswallet.app.web3.OnEthCallListener;
import com.gaaiuswallet.app.web3.OnSignMessageListener;
import com.gaaiuswallet.app.web3.OnSignPersonalMessageListener;
import com.gaaiuswallet.app.web3.OnSignTransactionListener;
import com.gaaiuswallet.app.web3.OnSignTypedMessageListener;
import com.gaaiuswallet.app.web3.OnWalletActionListener;
import com.gaaiuswallet.app.web3.OnWalletAddEthereumChainObjectListener;
import com.gaaiuswallet.app.web3.Web3View;
...
import com.gaaiuswallet.app.widget.AddressBar;
import com.gaaiuswallet.app.widget.AddressBarListener;
import com.gaaiuswallet.app.widget.TestNetDialog;
        ...
        ActionSheetCallback, TestNetDialog.TestNetDialogCallback
{
    ...
    private boolean loadUrl(String urlText)
    {
        ...
        {
            //reset url string back to GAAIUSWallet
