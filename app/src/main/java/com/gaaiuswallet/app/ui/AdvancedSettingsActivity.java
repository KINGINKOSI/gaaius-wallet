...
import com.gaaiuswallet.app.viewmodel.AdvancedSettingsViewModel;
        ...
        switch (requestCode)
        {
            case HomeActivity.RC_ASSET_EXTERNAL_WRITE_PERM:
                if (viewModel.createDirectory())
                {
                    ...
                    showGAAIUSWalletDirectoryConfirmation();
                }
                break;
        }
    }

    private void showGAAIUSWalletDirectoryConfirmation()
    {
