...
import static com.gaaiuswallet.app.C.ADDED_TOKEN;
import static com.gaaiuswallet.app.C.RESET_WALLET;
import static com.gaaiuswallet.app.C.SHOW_BACKUP;
import static com.gaaiuswallet.app.entity.WalletPage.ACTIVITY;
import static com.gaaiuswallet.app.entity.WalletPage.DAPP_BROWSER;
import static com.gaaiuswallet.app.entity.WalletPage.SETTINGS;
import static com.gaaiuswallet.app.entity.WalletPage.WALLET;
...
import com.gaaiuswallet.app.entity.HomeCommsInterface;
import com.gaaiuswallet.app.entity.HomeReceiver;
import com.gaaiuswallet.app.entity.MediaLinks;
import com.gaaiuswallet.app.entity.SignAuthenticationCallback;
import com.gaaiuswallet.app.entity.Wallet;
import com.gaaiuswallet.app.entity.WalletPage;
import com.gaaiuswallet.app.entity.WalletType;
import com.gaaiuswallet.app.entity.attestation.AttestationImportInterface;
import com.gaaiuswallet.app.entity.attestation.SmartPassReturn;
import com.gaaiuswallet.app.entity.tokens.TokenCardMeta;
import com.gaaiuswallet.app.router.ImportTokenRouter;
import com.gaaiuswallet.app.service.DeepLinkService;
import com.gaaiuswallet.app.service.GasService;
import com.gaaiuswallet.app.service.PriceAlertsService;
import com.gaaiuswallet.app.ui.widget.entity.ActionSheetCallback;
import com.gaaiuswallet.app.ui.widget.entity.PagerCallback;
import com.gaaiuswallet.app.util.LocaleUtils;
import com.gaaiuswallet.app.util.UpdateUtils;
import com.gaaiuswallet.app.util.Utils;
import com.gaaiuswallet.app.viewmodel.BaseNavigationActivity;
import com.gaaiuswallet.app.viewmodel.HomeViewModel;
import com.gaaiuswallet.app.viewmodel.WalletConnectViewModel;
    ...
    public void onStateChanged(@NonNull LifecycleOwner source, @NonNull Lifecycle.Event event)
    {
        switch (event)
        {
            case ON_CREATE:
                break;
            case ON_START:
                Timber.tag("LIFE").d("GAAIUSWallet into foreground");
                handler.postDelayed(() -> {
                    if (viewModel != null)
                    {
            ...
            case ON_PAUSE:
                break;
            case ON_STOP:
                Timber.tag("LIFE").d("GAAIUSWallet into background");
    ...
    private void checkWarnings()
    {
        if (updatePrompt)
        {
            ...
            if (warns < 3)
            {
                ...
                cDialog.setTitle(R.string.gaaiuswallet_update);
