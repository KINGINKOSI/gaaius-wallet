...
import com.gaaiuswallet.app.entity.analytics.TokenSwapEvent;
import com.gaaiuswallet.app.entity.lifi.Chain;
import com.gaaiuswallet.app.entity.lifi.Connection;
import com.gaaiuswallet.app.entity.lifi.Quote;
import com.gaaiuswallet.app.entity.lifi.Token;
import com.gaaiuswallet.app.service.GasService;
import com.gaaiuswallet.app.ui.widget.entity.ActionSheetCallback;
import com.gaaiuswallet.app.ui.widget.entity.ProgressInfo;
import com.gaaiuswallet.app.util.BalanceUtils;
import com.gaaiuswallet.app.util.SwapUtils;
import com.gaaiuswallet.app.viewmodel.SwapViewModel;
import com.gaaiuswallet.app.viewmodel.Tokens;
...
import com.gaaiuswallet.app.widget.SelectTokenDialog;
import com.gaaiuswallet.app.widget.StandardHeader;
import com.gaaiuswallet.app.widget.SwapSettingsDialog;
import com.gaaiuswallet.app.widget.TokenInfoView;
import com.gaaiuswallet.app.widget.TokenSelector;
...
public class SwapActivity extends BaseActivity implements StandardFunctionInterface, ActionSheetCallback
{
    ...
    private com.gaaiuswallet.app.entity.tokens.Token token;
    ...
    private ActionSheetDialog createConfirmationAction(Quote quote)
    {
        ...
        try
        {
            com.gaaiuswallet.app.entity.tokens.Token activeToken = viewModel.getTokensService().getTokenOrBase(sourceToken.chainId, sourceToken.address);
