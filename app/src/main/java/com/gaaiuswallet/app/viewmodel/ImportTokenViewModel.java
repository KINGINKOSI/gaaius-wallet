...
import static com.gaaiuswallet.app.entity.MagicLinkParcel.generateReverseTradeData;
import static com.gaaiuswallet.token.tools.ParseMagicLink.currencyLink;
import static com.gaaiuswallet.token.tools.ParseMagicLink.customizable;
...
import static com.gaaiuswallet.token.tools.ParseMagicLink.unassigned;
...
public class ImportTokenViewModel extends BaseViewModel implements TransactionSendHandlerInterface
{
    ...
    ImportTokenViewModel(GenericWalletInteract genericWalletInteract,
                         ...
                         GAAIUSWalletService alphaWalletService,
