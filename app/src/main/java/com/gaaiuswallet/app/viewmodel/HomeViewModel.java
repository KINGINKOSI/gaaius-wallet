...
import com.gaaiuswallet.app.entity.GitHubRelease;
...
import com.gaaiuswallet.app.entity.Version;
...
import com.gaaiuswallet.app.ui.AddTokenActivity;
import com.gaaiuswallet.app.ui.HomeActivity;
import com.gaaiuswallet.app.ui.ImportWalletActivity;
...
import com.gaaiuswallet.app.widget.EmailPromptView;
import com.gaaiuswallet.app.widget.QRCodeActionsView;
import com.gaaiuswallet.app.widget.WhatsNewView;
...
{
    public static final String ALPHAWALLET_DIR = "GAAIUSWallet";
    ...
    private final GAAIUSWalletNotificationService alphaWalletNotificationService;
    ...
    HomeViewModel(
            ...
            GAAIUSWalletNotificationService alphaWalletNotificationService,
    ...
    private Request getRequest()
    {
        return new Request.Builder()
            ...
            .url("https://api.github.com/repos/gaaiuswallet/gaaius-wallet-android/releases")
            .get()
            .build();
    }
    ...
    {
        alphaWalletNotificationService.subscribe(com.gaaiuswallet.ethereum.EthereumNetworkBase.MAINNET_ID);
    }

    public void unsubscribeToNotifications()
    {
        alphaWalletNotificationService.unsubscribeToTopic(com.gaaiuswallet.ethereum.EthereumNetworkBase.MAINNET_ID);
    }
