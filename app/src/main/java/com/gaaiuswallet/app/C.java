...
public abstract class C {
    ...
    public static final String ALPHAWALLET_WEB = "https://www.gaaiuswallet.com";
    ...
    public static final String APP_FOREGROUND_STATE = "com.gaaiuswallet.APP_FOREGROUND_STATE";
    public static final String EXTRA_APP_FOREGROUND = "com.gaaiuswallet.IS_FOREGORUND";
    public static final String QRCODE_SCAN = "com.gaaiuswallet.QRSCAN";
    public static final String AWALLET_CODE = "com.gaaiuswallet.AWALLET";
    public static final String SIGNAL_NFT_SYNC = "com.gaaiuswallet.SYNC_NFT";
    public static final String SYNC_STATUS = "com.gaaiuswallet.SYNC_STATUS";
    ...
    public static final String DAPP_PREFIX_ALPHAWALLET = "gaaiuswallet";
    ...
    public static final String ALPHAWALLET_LOGO_URI = "https://gaaiuswallet.com/wp-content/themes/gaaiuswallet/img/logo-horizontal-new.svg";
    public static final String ALPHAWALLET_WEBSITE = "https://gaaiuswallet.com";
    ...
    public static final String EXTERNAL_APP_DOWNLOAD_LINK = "https://gaaiuswallet.com/download/GAAIUSWallet-release-build.apk";
