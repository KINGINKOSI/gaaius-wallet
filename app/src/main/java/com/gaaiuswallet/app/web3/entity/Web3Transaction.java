package com.gaaiuswallet.app.web3.entity;
...
import com.gaaiuswallet.app.entity.walletconnect.SignType;
...
import com.gaaiuswallet.app.util.StyledStringBuilder;
...
public class Web3Transaction implements Parcelable
{
     ...
     * @param minGas
     */
    public Web3Transaction(com.gaaiuswallet.app.entity.Transaction tx, ActionSheetMode mode, BigInteger minGas)
    {
