...
public class DappBrowserUtils
{
    ...
    private static final String DEFAULT_HOMEPAGE = "https://gaaiuswallet.com/browser/";
    private static final String POLYGON_HOMEPAGE = "https://gaaiuswallet.com/browser-item-category/polygon/";
