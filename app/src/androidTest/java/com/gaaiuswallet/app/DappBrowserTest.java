...
import static com.gaaiuswallet.app.steps.Steps.navigateToBrowser;
import static com.gaaiuswallet.app.steps.Steps.openOptionsMenu;
import static com.gaaiuswallet.app.steps.Steps.selectTestNet;
import static com.gaaiuswallet.app.util.Helper.click;
import static com.gaaiuswallet.app.util.Helper.waitUntilLoaded;
...
public class DappBrowserTest extends BaseE2ETest
{
    ...
    public void should_suggest_websites()
    {
        ...
        Helper.wait(2);
        assertUrlContains("gaaiuswallet.app.entity.DApp@");
    }
