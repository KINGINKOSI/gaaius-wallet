...
-keep class com.gaaiuswallet.token.** { *; }
-keep class com.gaaiuswallet.app.walletconnect.** { *; }
-keep class com.gaaiuswallet.app.web3.** { *; }
-keep class com.gaaiuswallet.app.web3j.** { *; }
-keep class com.gaaiuswallet.app.entity.** { *; }
